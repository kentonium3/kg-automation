...
- [Spec-Kitty 4.0.0rc4 Upgrade Findings](<./diagnostics/spec-kitty-4.0.0rc4-upgrade-findings.md>) — QA-agent-facing register of the 12 findings from the 3.2.7 → 4.0.0rc4-candidate upgrade (2026-09-17→19); build-pinned, maps each finding to its kg-automation issue and upstream fix commit
