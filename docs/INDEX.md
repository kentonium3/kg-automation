...
- [Felix-Vikunja Sync Driver Operations](<./runbooks/sync-driver-ops.md>) — install, bootstrap, observe, and recover the Felix-Vikunja reconciliation driver per ADR-0003: 5-min systemd timer, 6-phase cycle, `conflict-events.jsonl` audit trail, three delivery guards (G-1/G-2/G-3), known soft edge for Vikunja server-side auto-advance, full SC-001..SC-009 verification commands. Mission #518.
