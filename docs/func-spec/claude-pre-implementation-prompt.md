...
deprecate this step. Proceed through the workflows with as few stops as possible but
ALWAYS stop at spec-kitty mandatory stop points and ALWAYS stop if design decision are
needed from me.
