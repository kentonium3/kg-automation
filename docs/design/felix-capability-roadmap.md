...
| Doc-auditor agent | 🔄 In progress | #105 | Hourly systemd-user timer on office2 cross-checks code vs. docs and files issues against drift. The doc-domain map (below) is its routing table. |
