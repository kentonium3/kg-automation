...
- **Schedule**: Morning check-in at 7:05 AM ET daily, weekly report Sunday 6 PM ET (cron `0 22 * * 0` America/New_York, verified phase-0 of mission `vikunja-client-and-habits-weekly-report-01KTKSFT`)
