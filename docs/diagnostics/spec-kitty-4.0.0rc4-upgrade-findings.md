...
| #1012 | **[#4999](https://github.com/spec-kitty/spec-kitty/issues/4999)** | OPEN, P3 | dry-run `PAYLOAD_INVALID` rows blank; 9.1.6 rules reject 2026-03 history, no repair | ✅ **FILED 2026-09-23** — [#4999](https://github.com/spec-kitty/spec-kitty/issues/4999); two claims corrected first (see packet) |
| #1013 | **[#4998](https://github.com/spec-kitty/spec-kitty/issues/4998)** | OPEN, P0 | CRLF sources → doubled `SKILL.md` frontmatter ×275; `--fix` cannot converge | ✅ **FILED 2026-09-23** — [#4998](https://github.com/spec-kitty/spec-kitty/issues/4998); cross-refs + charter prior art added |
