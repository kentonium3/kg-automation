...
Subtasks:
- [ ] T001 `mark_processed` tests + impl (WP01) [P]
- [ ] T002 `mark_processed` coverage gate ≥90%/85% (WP01)
...
Subtasks:
- [ ] T003 `route_journal_entry` tests + impl (WP02) [P]
- [ ] T004 `route_journal_entry` coverage gate (WP02)
...
Subtasks:
- [ ] T005 `route_someday` tests + impl (WP03) [P]
- [ ] T006 `route_someday` coverage gate (WP03)
...
Subtasks:
- [ ] T007 `route_calendar_event` tests + impl (WP04) [P]
- [ ] T008 `route_calendar_event` coverage gate (WP04)
...
Subtasks:
- [ ] T009 `handle_clarification_state` tests + impl (WP05) [P]
- [ ] T010 `handle_clarification_state` coverage gate (WP05)
...
Subtasks:
- [ ] T011 `classify_content` tests + impl (WP06) [P]
- [ ] T012 `classify_content` coverage gate (WP06)
