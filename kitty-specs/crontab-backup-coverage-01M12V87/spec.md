...
| C-006 | Tier 2 change control | The backup path is Tier 2. A recent Restic backup must be confirmed before host-side modification, per the change-risk taxonomy. | Regulatory | High | Open |
