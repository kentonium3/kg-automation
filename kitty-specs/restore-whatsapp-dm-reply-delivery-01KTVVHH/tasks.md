...
- [ ] T001 H6 openclaw upgrade probe + plan (WP01)
- [ ] T002 H5 plugin install state + version check (WP01)
- [ ] T003 H4 config-swap probe matrix (WP01)
- [ ] T004 H2 missing-field discovery (WP01)
- [ ] T005 H3 AGENTS.md rollback probe (WP01)
- [ ] T006 Synthesize Decision Record into research.md (WP01)
- [ ] T007 Open + resolve spec-kitty decision (WP01)
