...
branch_strategy: Lane worktree allocated by spec-kitty finalize-tasks. Implementation commits land in that worktree; merge to main happens at /spec-kitty.merge.
subtasks:
- T001
- T002
- T003
