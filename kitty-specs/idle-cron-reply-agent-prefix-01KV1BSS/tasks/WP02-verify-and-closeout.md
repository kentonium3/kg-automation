...
branch_strategy: Planning artifacts and code for this mission live on feat/idle-cron-reply-agent-prefix. During /spec-kitty.implement this WP branches from WP01's HEAD via the dependency chain. Completed changes must merge back into feat/idle-cron-reply-agent-prefix. The GitHub PR from feat/idle-cron-reply-agent-prefix to main is opened after spec-kitty.merge.
subtasks:
- T006
- T007
- T008
