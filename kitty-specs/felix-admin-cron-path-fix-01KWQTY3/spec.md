...
- Repointing the **observation-digest** logging (`scripts/openclaw/observation/config.py`, `log_action.py`, `summarize.py`, felix-core-digest / F014) and the **full decommission** of `/home/claude/second-brain` — deferred to the fast-follow **#659** (this mission narrows FR-008/SC-5 accordingly to avoid breaking that active subsystem).
