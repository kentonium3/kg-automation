...
| #561 | Habits output discipline (Hard Rules) | deferred-with-followup | Follow-up: WP03 in this mission delivers Hard Rules edits; verdict transitions to `fixed` on mission merge |
...
| #563 | Inbox cleanup unprocessed-archive | deferred-with-followup | Follow-up: #563 itself remains open for a follow-on inbox-pipeline mission — explicitly out of scope for this slice |
| #562 | Habits weekly report unimplemented + LLM-improvised data | deferred-with-followup | Follow-up: WP02 + WP03 in this mission deliver the fix; verdict transitions to `fixed` on mission merge |
