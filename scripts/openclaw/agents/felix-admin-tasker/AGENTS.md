...
```bash
cd /home/claude/kg-automation && python3 -m scripts.enrichment.derive_state --task-id <id>
```
...
```bash
cd /home/claude/kg-automation && python3 -m scripts.enrichment.record_completion \
